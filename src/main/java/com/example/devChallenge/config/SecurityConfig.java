package com.example.devChallenge.config;

import com.example.devChallenge.security.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/solutions/**").permitAll()
